...
infoblox.prototype.getNetworkContainer = function(subnet) {
  let query = 'networkcontainer?network=' + subnet + '&_return_fields%2B=extattrs';
  var client = this;
  return client._req(query, { method: 'GET' });
};

infoblox.prototype.getNextNetworkContainer = function(netId, cidr, num) {
...
//  "Site": { "value": "East" }
//}
infoblox.prototype.createNetwork = function (parentNetId, network, comment, extattrs) {
...
infoblox.prototype.deleteObject = function (ref) {
  return this._req(`${ref}`, {
        method: 'DELETE'
  });
};
...
infoblox.prototype.getHostByAttr = function(query) {
...
infoblox.prototype.getHost = function(ip) {
  return this._req('ipv4address?_return_fields%2B=extattrs&ip_address=' + ip, {
    method: 'GET'
  });
};
